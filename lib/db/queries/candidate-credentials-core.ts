...
/**
 * Return a paginated, searchable slice of a candidate’s credentials together
 * with aggregated status counts.  Designed for reuse by multiple feature
 * modules (candidate dashboard, recruiter view, public profile, admin, etc.).
 */
