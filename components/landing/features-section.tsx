      ...
      <div className='mx-auto max-w-6xl px-4 text-center'>
        ...
        <div className='mt-14 grid gap-8 sm:grid-cols-2 lg:grid-cols-4'>
          {features.map(({ icon: Icon, title, description }) => (
            ...
            >
              <div className='bg-flare-gradient mb-4 inline-flex size-12 items-center justify-center rounded-full text-white shadow-lg'>
              ...
              <div className='pointer-events-none absolute inset-0 -z-10 opacity-0 transition-opacity duration-300 group-hover:opacity-15'>
                <div className='bg-flare-gradient absolute inset-0 blur-3xl' />
              </div>
            </div>
          ))}
        </div>
